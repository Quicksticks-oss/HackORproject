    ...
    return (
      <>
        ...
        <Paragraph className="paragraph">
          The internet is pretty much just a bunch of computers connected to a shared network sharing information across it. On the local level, you have wi-fi and Ethernet as standards for communication between local machines, forming a Local Area Network (LAN). Through a router that routes information that needs to leave or enter the LAN, these routers then connect to form a Wide Area Network (WAN). WANs are then connected through more routers and more network hierarchies until nearly every computer on the planet is connected to each other. This is how the internet is structured.
        </Paragraph>
        <Paragraph className="paragraph">
